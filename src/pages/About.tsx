...
const skills = [
  {
    ...
    desc: "Captation, montage, motion design, du rush au rendu final.",
  },
  {
    icon: Code2,
  ...
  },
  {
    icon: Palette,
    title: "Design & UX/UI",
    desc: "Identité visuelle, maquettes.",
  },
  {
    icon: Camera,
  ...
  },
  {
    ...
    desc: "Comprendre les algorithmes, les plateformes, les tendances.",
  },
  {
    icon: Megaphone,
    title: "Communication",
    desc: "Stratégie de contenu, storytelling, personal branding.",
  },
  {
    icon: Layers,
    title: "Gestion de projet",
    desc: "Apprendre à travailler seul pour avoir un projet structuré.",
  },
  {
    icon: Users,
    title: "Travail collaboratif",
    desc: "Apprendre à parler tous les langages.",
  },
];
...
const impacts = [
  {
    icon: Lightbulb,
    title: "Un regard 360°",
    desc: "MMI m'a appris à voir un projet sous tous ses angles à la fois : le fond, la forme, la technique et l'audience. Quand je monte une vidéo, je pense déjà à la miniature et au titre.",
  },
  {
    icon: TrendingUp,
    title: "Passer de zéro à tout faire soi-même",
    desc: "Avant de déléguer, il faut comprendre. MMI m'a donné les bases pour tout faire moi-même : tourner, monter, designer, publier. Ça donne une autonomie totale sur mes projets créatifs.",
  },
  {
    icon: Video,
    title: "La vidéo comme métier, pas juste un hobby",
    desc: "C'est la formation qui m'a structuré. J'avais déjà l'envie, MMI m'a donné les outils, le vocabulaire et la rigueur pour en faire quelque chose de professionnel.",
  },
  {
    icon: Globe,
    title: "Comprendre Internet",
    desc: "Savoir comment fonctionne un site, un algorithme, une campagne : ça change la manière dont tu crées du contenu.",
  },
];
    ...
    <div className="max-w-5xl mx-auto py-10 space-y-24">
      ...
      >
        ...
        <p className="text-lg text-zinc-400 max-w-2xl leading-relaxed">
          ...
          , je suis une formation pluridisciplinaire qui allie vidéo,
          développement web, design graphique et communication. C'est ce cursus
          complet qui m'a permis de structurer ma passion et de la transformer
          en de véritables compétences professionnelles.
        </p>
      </motion.div>
      ...
      <section className="space-y-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            Mes compétences de MMI
          </h2>
          <p className="text-zinc-500">
            Ce que la formation m'a appris à maîtriser.
          </p>
        </motion.div>
